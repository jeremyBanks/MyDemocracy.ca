...
/*
     FILE ARCHIVED ON 19:02:08 Feb 8, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:34:48 Feb 27, 2017.
    ...
    Granite.HTTP = (function() {
        ...
        self.getSchemeAndAuthority = function (url) {
            ...
            try {
                ...
                return (end == -1) ?
                    url :   // e.g. url was /web/20170208190208/http://www.day.com
                    url.substring(0, end);  // e.g. url was /web/20170208190208/http://www.day.com/en.html
            }
            catch (e) {
                return "";
            }
         ...
         * <pre><code>
         /web/20170208190208/http://www.day.com/foo/bar.html => /foo/bar
         </code></pre><p>
         * @static
...
(function (document, Granite, util, http, $) {
     ...
     *   <li><code>data-i18n-dictionary-src</code> attribute at &lt;html&gt; element, which has the type of <a href="/web/20170208190208/http://tools.ietf.org/html/rfc6570">URI Template</a> string</li>
